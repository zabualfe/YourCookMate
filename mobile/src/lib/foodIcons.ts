...
export const FOOD_ICON_PRESETS: FoodIconPreset[] = [
  ...
  { id: 'salad', label: 'Salad', icon: 'leaf', background: '#f2f7f4', foreground: '#1f533c' },
  ...
  { id: 'sprout', label: 'Greens', icon: 'sprout', background: '#f2f7f4', foreground: '#266849' },
  { id: 'vegan', label: 'Vegan', icon: 'leaf-circle', background: '#dcece3', foreground: '#1f533c' },
  { id: 'leafy', label: 'Plant-based', icon: 'leaf', background: '#dcece3', foreground: '#1f533c' },
  ...
  { id: 'cocktail', label: 'Cocktail', icon: 'glass-cocktail', background: '#f2f7f4', foreground: '#266849' },
  ...
  { id: 'chef', label: 'Chef special', icon: 'chef-hat', background: '#f2f7f4', foreground: '#1f533c' },
